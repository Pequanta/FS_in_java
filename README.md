# FS_in_java
This is a FileSystem I built as a means to learn java with practice. In the program I used LinkedList structure to build the file system and stack data structure to 
